...
export { getCurrentTmuxSession, getCurrentTmuxPaneId, getTeamTmuxSessions, formatTmuxInfo, } from './rmux.js';
    ...
    try {
        ...
        if (shouldIncludeTmuxTail(verbosity) &&
            ...
            (event === 'session-idle' ||
                ...
                event === 'session-stop')) {
            try {
                const { capturePaneContent } = await import('../features/rate-limit-wait/rmux-detector.js');
