...
export function validateTeamConfig(config) {
    ...
    if (ops && typeof ops === 'object') {
        ...
        if (ops.worktreeMode !== undefined) {
            ...
            if (typeof ops.worktreeMode !== 'string' ||
...
function isAutopilotWorkflowSequence(stages) {
    return AUTOPILOT_WORKFLOW_SEQUENCES.some((sequence) => stages.length === sequence.length &&
        stages.every((stage, index) => typeof stage === 'string' && stage === sequence[index]));
}
