...
export const lspWorkspaceSymbolsTool = {
    ...
    schema: {
        ...
        file: z
            .string()
            .describe('Any file in the workspace (used to determine which language server to use)'),
    },
    handler: async (args) => {
...
export const lspCodeActionResolveTool = {
    ...
    schema: {
        ...
        actionIndex: z
            ...
            .int()
            .min(1)
            .describe('Index of the action (1-indexed, from lsp_code_actions output)'),
    },
    handler: async (args) => {
...
export const lspDiagnosticsDirectoryTool = {
    ...
    schema: {
        ...
        strategy: z
            .enum(['tsc', 'lsp', 'auto'])
            .optional()
            .describe('Strategy to use: "tsc" (TypeScript compiler), "lsp" (Language Server iteration), or "auto" (default: auto-detect)'),
    },
    handler: async (args) => {
