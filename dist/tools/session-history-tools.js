...
export const sessionSearchTool = {
    ...
    schema: {
        ...
        since: z
            .string()
            .optional()
            .describe('Only include matches since a relative duration (e.g. 7d, 24h) or absolute date'),
        project: z
            .string()
            .optional()
        ...
        contextChars: z
            ...
            .positive()
            .optional()
            .describe('Approximate snippet context on each side of a match (default: 120)'),
        workingDirectory: z
            .string()
            .optional()
            .describe('Working directory used to determine the current project scope'),
    },
    handler: async (args) => {
        try {
