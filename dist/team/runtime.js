...
import { createTeamSession, spawnWorkerInPane, sendToWorker, isWorkerAlive, killTeamSession, resolveSplitPaneWorkerPaneIds, waitForPaneReady, applyMainVerticalLayout, killTeamPane, splitTeamWorkerPane, } from './rmux-session.js';
...
export async function spawnWorkerForTask(runtime, workerNameValue, taskIndex) {
    ...
    const resolvedBinaryPath = runtime.resolvedBinaryPaths?.[agentType] ??
