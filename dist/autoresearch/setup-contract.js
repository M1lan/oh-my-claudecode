import { parseSandboxContract, slugifyMissionName, } from './contracts.js';
...
export function validateAutoresearchSetupHandoff(raw) {
    ...
    const candidate = raw;
    const missionText = typeof candidate.missionText === 'string'
        ? candidate.missionText.trim()
        : '';
    const evaluatorCommand = typeof candidate.evaluatorCommand === 'string'
