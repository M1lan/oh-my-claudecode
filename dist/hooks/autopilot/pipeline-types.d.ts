...
export type WorkflowProfileStages = readonly ['ralplan', 'execution'] | readonly ['ralplan', 'execution', 'ralph'] | readonly ['ralplan', 'execution', 'qa'] | readonly ['ralplan', 'execution', 'ralph', 'qa'];
