---
name: ask
description: Process-first advisor routing for Claude, Codex, Gemini, Grok, Cursor, or Gajae-Code (gjc) via `omc ask`, with artifact capture and no raw CLI assembly
---

# Ask

Use OMC's canonical advisor skill to route a prompt through the local Claude, Codex, Gemini, Grok, Cursor, or Gajae-Code (gjc) CLI and persist the result as an ask artifact.
...
/oh-my-claudecode:ask gjc "second opinion on this TypeScript refactor"
```
