...
export const CONFIG_PATTERNS = [
  ...
  {
    file: 'package.json',
    indicates: { language: 'JavaScript/TypeScript', packageManager: 'npm' },
  },
  ...
  {
    file: 'Cargo.toml',
    indicates: { language: 'Rust', packageManager: 'cargo' },
  },
  ...
  { file: 'pyproject.toml', indicates: { language: 'Python' } },
  {
    ...
    indicates: { language: 'Python', packageManager: 'pip' },
  },
  ...
  {
    file: 'build.gradle',
    indicates: { language: 'Java/Kotlin', packageManager: 'gradle' },
  },
  {
    file: 'build.gradle.kts',
    indicates: { language: 'Kotlin', packageManager: 'gradle' },
  },

  // Ruby
  {
    file: 'Gemfile',
    indicates: { language: 'Ruby', packageManager: 'bundler' },
  },
  ...
  {
    file: 'composer.json',
    indicates: { language: 'PHP', packageManager: 'composer' },
  },
