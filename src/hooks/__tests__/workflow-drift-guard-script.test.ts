...
function restoreEnvironment(
  name: 'DISABLE_OMC' | 'OMC_SKIP_HOOKS',
...
describe('workflow-drift-guard Stop hook', () => {
    ...
    expect(registrations).toEqual([
      {
        ...
        type: 'command',
        command:
          'node "$CLAUDE_PLUGIN_ROOT"/scripts/run.cjs "$CLAUDE_PLUGIN_ROOT"/scripts/workflow-drift-guard.mjs',
        timeout: 3,
      },
    ]);
  ...
  it('uses canonical current-message evidence and preserves aliases', () => {
    const fixture = join(
      mkdtempSync(join(tmpdir(), 'omc-workflow-drift-transcript-')),
      'transcript.txt',
    );
    writeFileSync(
      fixture,
      'I found two viable paths. Which approach should I take?\n',
    );
    expectPass(
      runGuard(guardInput('Should I proceed?', { transcript_path: fixture })),
    );

    writeFileSync(fixture, 'Should I proceed?\n');
    expectBlock(
      runGuard(
        guardInput('PostgreSQL or SQLite?', { transcript_path: fixture }),
      ),
    );
  ...
  it.each([
    ...
    '%s does not fall through from a present canonical key',
    (_id, last_assistant_message) => {
      expectPass(
        runGuard({
          hook_event_name: 'Stop',
          last_assistant_message,
  ...
  it.each([
    ...
    [
      'AS-01',
      'PostgreSQL and SQLite are viable options. Which option should I choose?',
    ],
    [
      'AS-03',
      'PostgreSQL and SQLite are viable options; the other module is unchanged. Which option should I choose?',
    ],
    [
      'AS-09',
      'PostgreSQL Primary and SQLite Replica are viable options. Which option should I choose?',
    ],
    [
      'DOT-02',
      'PostgreSQL.v2 and v2 are viable options. Which option should I choose?',
    ],
    ...
    [
      'C-07',
      'One path was ruled out; two viable paths remain. Which approach should I take?',
    ],
    [
      'C-08',
      'One option was resolved; two viable options remain. Which option should I choose?',
    ],
    [
      'C-09',
      'One approach was discarded; two viable approaches remain. Which approach should I use?',
    ],
    ...
    [
      'L-02',
      'PostgreSQL, SQLite, and MySQL were considered; PostgreSQL was ruled out. Which should I choose?',
    ],
    [
      'ATTACH-01',
      'The PostgreSQL, SQLite, and MySQL were considered; PostgreSQL was ruled out. Which should I choose?',
    ],
    [
      'L-06',
      'PostgreSQL, PostgreSQL, and SQLite are viable options. Which option should I choose?',
    ],
    [
      'L-09',
    ...
    [
      'FF-04',
      'The other module is unchanged. I found two viable paths. Which approach should I take?',
    ],
    [
      'FF-05',
      'Paste any value if needed. PostgreSQL and SQLite are viable options. Which should I choose?',
    ],
    [
      'H-02',
      'PostgreSQL and SQLite are viable options. Which should I choose?',
  ...
  it.each([
    ...
    [
      'AS-02',
      'PostgreSQL and SQLite are viable. I ran the tests. Which should I choose?',
    ],
    ['AS-04', 'PostgreSQL and SQLite are viable. Which database is faster?'],
    [
      'AS-05',
      'PostgreSQL and SQLite were considered; PostgreSQL was ruled out. Should I proceed?',
    ],
    [
      'AS-06',
      'PostgreSQL and Other/free-form are viable options. Which option should I choose?',
    ],
    [
      'AS-07',
      'This and PostgreSQL are viable options. Which option should I choose?',
    ],
    [
      'AS-08',
      'PostgreSQL and PostgreSQL are viable options. Which option should I choose?',
    ],
    [
      'AS-10',
      'Research and Development and SQLite are viable options. Which option should I choose?',
    ],
    [
      'C-04',
      'I found two viable paths, but one path was ruled out. Which approach should I take?',
    ],
    [
      'C-05',
      'There are two viable options, but one option was resolved. Which option should I choose?',
    ],
    [
      'C-06',
      'I found two viable approaches, but one approach was already chosen. Which approach should I use?',
    ],
    ...
    [
      'C-15',
      'I found two viable paths, but one path got ruled out. Which approach should I take?',
    ],
    [
      'OL-03',
      'Options:\n- PostgreSQL\n- SQLite\nI ran the tests.\nWhich should I choose?',
    ...
    [
      'M-11',
      'const mode = preferSql ? PostgreSQL : SQLite; Which should I choose?',
    ],
    ...
    [
      'M-18',
      'PostgreSQL and /unfinished SQLite are viable options. Which should I choose?',
    ],
    [
      'MASK-01',
      'PostgreSQL and mode:/unfinished SQLite are viable options. Which should I choose?',
    ],
    ...
    [
      'L-01',
      'PostgreSQL, SQLite, and MySQL were considered; PostgreSQL was ruled out and SQLite was eliminated. Which should I choose?',
    ],
    [
      'L-03',
      'PostgreSQL and SQLite were considered; only SQLite remains. Which should I choose?',
    ],
    [
      'L-04',
      'PostgreSQL and SQLite were considered; PostgreSQL was already chosen. Which should I choose?',
    ],
    [
      'L-05',
      'PostgreSQL, SQLite, and MySQL were considered; one was ruled out. Which should I choose?',
    ],
    ...
    [
      'L-11',
      'PostgreSQL and SQLite were considered; PostgreSQL was deprecated. Which should I choose?',
    ],
    [
      'L-13',
      'Options:\n- PostgreSQL - ruled out\n- SQLite\n- MySQL\nWhich should I choose?',
    ...
    [
      'L-14',
      'PostgreSQL, SQLite, and MySQL were considered; PostgreSQL was ruled out, SQLite was eliminated. Which should I choose?',
    ],
    [
      'L-15',
      'PostgreSQL and SQLite were considered; MySQL was ruled out. Which should I choose?',
    ],
    [
      'L-16',
      'PostgreSQL, PostgreSQL, and SQLite were considered; PostgreSQL was ruled out. Which should I choose?',
    ],
    [
      'FF-01',
      'Options:\n- PostgreSQL\n- SQLite\n- Other/free-form\nWhich should I choose?',
    ...
    [
      'FF-02',
      'PostgreSQL and SQLite are viable options, or paste the exact connection string. Which should I use?',
    ],
    [
      'FF-06',
      'PostgreSQL and SQLite are viable options, or say anything else you want. Which should I choose?',
    ],
    ...
    '%s fails open for unsupported, ambiguous, or open-input syntax',
    (_id, message) => {
        ...
        prior_tool_calls: [
          {
            ...
            input: { question: 'Database?', options: ['PostgreSQL', 'SQLite'] },
          },
        ],
      },
    );
  ...
  it('fails open while already continuing from a Stop hook', () => {
    expectPass(
      runGuard(guardInput('PostgreSQL or SQLite?', { stop_hook_active: true })),
    );
    expectPass(
      runGuard(guardInput('PostgreSQL or SQLite?', { stopHookActive: true })),
    );
  });
  ...
  it('honors explicit skip controls only when supplied to the child process', () => {
    expectPass(
      runGuard(guardInput('PostgreSQL or SQLite?'), { DISABLE_OMC: '1' }),
    );
    expectPass(
      runGuard(guardInput('PostgreSQL or SQLite?'), { DISABLE_OMC: 'true' }),
    );
    expectPass(
      runGuard(guardInput('PostgreSQL or SQLite?'), {
  ...
  it('allows ready-to-continue wording while work is not being claimed complete', () => {
    ...
    expectPass(
      runGuard({
        hook_event_name: 'Stop',
        last_assistant_message:
          'I am ready to continue after checking the next step.',
        cwd,
      }),
    );
  });
  ...
  it('allows TODO blockers while work is not being claimed complete', () => {
    ...
    expectPass(
      runGuard({
        hook_event_name: 'Stop',
        last_assistant_message:
          'I found the next implementation step and will continue after checking tests.',
        cwd,
      }),
    );
  });
