...
export const TEAM_TERMINAL_TASK_STATUSES: ReadonlySet<TeamTaskStatus> =
  new Set<TeamTaskStatus>(["completed", "failed"]);
export const TEAM_TASK_STATUS_TRANSITIONS: Readonly<
...
export function canTransitionTeamTaskStatus(
  from: TeamTaskStatus,
  to: TeamTaskStatus,
): boolean {
...
export const TEAM_TASK_APPROVAL_STATUSES = [
  "pending",
  "approved",
  "rejected",
] as const;
export type TeamTaskApprovalStatus =
  (typeof TEAM_TASK_APPROVAL_STATUSES)[number];
